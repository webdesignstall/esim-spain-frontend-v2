    ...
    >
      ...
      <div className="grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 gap-7">
        {Array.from({ length: 15 }).map((item, index) => (
          <div
            className="bg-[#343230]  h-[218px]  rounded-xl group hover:border-[1px] hover:border-[#8E8E8E] border-[1px] border-[#343230] flex flex-col items-center justify-center px-2 py-7 text-center mb-16 relative"
            key={index}
          >
            <div className="absolute -top-28 left-0 w-full h-full flex items-center justify-center">
              <img
                className="2xl:w-[53%] 2xl:h-[55%] lg:w-[45%] lg:h-[40%] rounded-full border-[8px] border-[#1F1B17]"
                src="https://i.ibb.co/5WNh9wm/bd-Country-Flag.png"
                alt="country flag"
              />
            </div>
            <div className="mb-5 mt-10">
              <h4 className="text-2xl text-white mb-1">Bangladesh</h4>
